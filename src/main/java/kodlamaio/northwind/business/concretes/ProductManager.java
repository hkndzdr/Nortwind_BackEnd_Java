...
public class ProductManager implements ProductService{
	...
	@Override
	public DataResult<Product> getByProductName(String produtName) {
		return new SuccessDataResult<Product>(this.productDao.getByProductName(produtName),"Data listelendi");
	}
